	...
	<nav class="navbar fixed-top navbar-expand-lg navbar-dark bg-dark">
		<div class="container-fluid">
			<div class="d-flex align-items-center text-secondary me-2">
				...
				<div v-if="store.isLoading()" class="spinner-border ms-auto spinner-border-sm d-lg-none" role="status"
			...
			<div id="navbarNav" ref="navmenu" class="collapse navbar-collapse" @click="closeNavBar">
				<ul class="navbar-nav me-auto">
					...
					<li class="nav-item me-lg-2">
						<router-link :to="appPaths.Reminder" class="nav-link d-flex align-items-center">
							<BIconFileEarmarkDiff />
							<span class="ms-1">Reminder</span>
						</router-link>
					</li>
					<li class="nav-item me-lg-2">
						<router-link :to="appPaths.Stats" class="nav-link d-flex align-items-center">
							<BIconFileEarmarkBarGraph />
							<span class="ms-1">Stats</span>
						</router-link>
					</li>
					<li class="nav-item me-lg-2">
						<router-link :to="appPaths.GroupList" class="nav-link d-flex align-items-center">
							<BIconFileEarmarkSpreadsheet />
							<span class="ms-1">Group list</span>
						</router-link>
					</li>
					<li class="nav-item me-lg-2">
						<router-link :to="appPaths.DifficultVocs" class="nav-link d-flex align-items-center">
							<BIconFileEarmarkMedical />
							<span class="ms-1">Difficult Words</span>
						</router-link>
					</li>
					<li class="nav-item me-lg-2">
						<router-link :to="appPaths.AppUser" class="nav-link d-flex align-items-center">
							<BIconFileEarmarkPerson />
					...
					<li class="nav-item dropdown">
						...
						<ul class="dropdown-menu">
							<li>
								<a class="dropdown-item" data-color-mode="auto" @click="handleColorChange('auto')">
									<BIconCircleHalf /> Auto
								</a>
							</li>
							<li>
								<a class="dropdown-item" data-color-mode="light" @click="handleColorChange('light')">
									<BIconSunFill /> Light
								</a>
							</li>
							<li>
								<a class="dropdown-item" data-color-mode="dark" @click="handleColorChange('dark')">
				...
				<div v-if="store.isLoading()" class="nav-item text-secondary ms-auto d-none d-lg-block">
				...
				<div class="nav-item dropdown text-secondary ms-lg-5 me-lg-1">
					...
					<ul class="dropdown-menu bg-dark m-0">
						<li>
							<a class="dropdown-item bg-dark text-secondary" role="button" @click="handleLogout()">
